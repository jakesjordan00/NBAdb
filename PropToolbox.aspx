<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PropToolbox.aspx.cs" Inherits="NBAdb.PropToolbox" MaintainScrollPositionOnPostBack="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-2" style="width:fit-content">
            <h1 style="width:fit-content">Prop Toolbox
        ...
        <div class="col">
            <div class="row" style="width:fit-content">
                ...
                <div class="col" style="width:350px">
                    <asp:Label ID="t1Name" runat="server" Text="" Font-Size="Large" Font-Bold="true" Width="250px"></asp:Label>
                </div>
                <div class="col" style="width:fit-content; margin-left:30px">
                    <asp:Label ID="opName" runat="server" Text="Opponent Stats" Font-Size="Large" Font-Bold="true" Visible="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">            
            <asp:HyperLink ID="p1Link" Target="_blank" runat="server"><abbr title="Select the player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Select Player:</abbr></asp:HyperLink> 
            <asp:DropDownList 
        ...
        <div class="col" style="margin-top:-20px">
            <div class="row" style="margin-top:0px; width:310px">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p2Link" Target="_blank" runat="server"><abbr title="Select the second player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 2:</abbr></asp:HyperLink>
            <asp:DropDownList 
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p3Link" Target="_blank" runat="server"><abbr title="Select the third player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 3:</abbr></asp:HyperLink>
            <asp:DropDownList 
        ...
        <div class="col-md-1" style="margin-top:-80px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-80px">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opFGtw" runat="server" Text="FG2M/FG2A:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opFG" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opFGR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p4Link" Target="_blank" runat="server"><abbr title="Select the fourth player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 4:</abbr></asp:HyperLink>
            <asp:DropDownList 
        ...
        <div class="col-md-1" style="margin-top:-110px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-110px">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opFGth" runat="server" Text="FG3M/FG3A:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opFG3" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opFG3R" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p5Link" Target="_blank" runat="server"><abbr title="Select the fifth player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 5:</abbr></asp:HyperLink>
            <asp:DropDownList 
        ...
        <div class="col-md-1" style="margin-top:-140px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-140px">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opF" runat="server" Text="FTM/FTA:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opFT" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opFTR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p6Link" Target="_blank" runat="server"><abbr title="Select the sixth player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 6:</abbr></asp:HyperLink>
            <asp:DropDownList 
        ...
        <div class="col-md-1" style="margin-top:-170px; width: fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-170px">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opBenc" runat="server" Text="Bench Pts:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opBench" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opBenchR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p7Link" Target="_blank" runat="server"><abbr title="Select the seventh player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 7:</abbr></asp:HyperLink>
            <asp:DropDownList 
        ...
        <div class="col-md-1" style="margin-top:-200px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        <div class="col-md-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="p8Link" Target="_blank" runat="server"><abbr title="Select the eighth player who you would like to include in your prop" style="font-size:Large; text-decoration-color:grey">Player 8:</abbr></asp:HyperLink>
            <asp:DropDownList 
        ...
        <div class="col-md-1" style="margin-top:-230px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-260px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-279px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-298px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-298px">
            <div class="row" style="margin-top:0px;">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opAs" runat="server" Text="Assists: " Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opAst" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opAstR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-317px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-317px">
            <div class="row" style="margin-top:0px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opRe" runat="server" Text="Rebounds:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opReb" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opRebR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col" style="margin-top:-336px;">
            <div class="row" style="margin-top:0px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="opODRe" runat="server" Text="ORB/DRB:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
                    <asp:Label ID="opODReb" runat="server" Text="" Font-Size="Medium" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-1" style="width:fit-content; padding-right: 0px">
                    <asp:Label ID="opODRebR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-355px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="Label20" runat="server" Text="Blks/Blked:" Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-374px; width:fit-content">
            <div class="row" style="margin-top:0px; width:310px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
        ...
        <div class="col" style="margin-top:-374px">
            <div class="row" style="margin-top:0px">
                ...
                <div class="col-md-1" style="width:auto">
                    <asp:Label ID="opStlR" runat="server" Text="" Font-Size="small" Font-Bold="false"></asp:Label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col-md-1" style="margin-top:-370px; width:fit-content">
            <div class="row">
        ...
        <div class="col-md-2" style="margin-top:-320px">              
            <div class="row">
    ...
    <div class="row" style="height:auto; padding-top: 10px">
        ...
        <div class="col" style="margin-top:-300px">
            <div class="row" style="margin-top:0px">
                <div class="col-md-1" style="width:125px; padding-right:0px">
                    <asp:Label ID="team2a" runat="server" Text=" 1: " Font-Size="Medium" Font-Bold="true" Visible="false"></asp:Label>
                </div>
                <div class="col-sm-1" style="width: 95px">
    ...
    <asp:Button ID="btnSmartFill" runat="server" Text="Smart Fill" class="btn btn-primary active" BackColor="#d9efd3" ForeColor="Black" BorderColor="Black" OnClick="btnSmartFill_Click" Enabled="true"/> 
    ...
    <asp:Label ID="lblOddsL" runat="server" Text="" Font-Bold="true"></asp:Label><br />
    ...
    <div class="row"> <%--This is the main row containing our full stat section--%>
        ...
        <div class="row" style="height:fit-content">
            <iframe id="teamNotes" src="Default.aspx#zoom=172" runat="server" style="height: 1800px; width:1800px; zoom:0" frameborder="0" visible="false"></iframe>
