<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PropAssistant.aspx.cs" Inherits="NBAdb.PropAssistant" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <%-- This section contains the options for props we want to include in our Prop. This first row are our checkboxes --%>
    <div class="row" style="">
        <div class="col-md-1" style="width:50px">
            <abbr title="Select the props to include. By selecting multiple, you can test the percentage of a particular prop." style="font-size:small; width:30px; text-decoration-color:grey">Props:</abbr>
        </div>
        <div class="col-md-1">
    ...
    <%-- This section is a repeat of the first, but if we'd like to include a second player in the Prop. --%>    
    ...
    <%-- This section is a repeat of the first and second, but if we'd like to include a third player in the Prop. --%>   
