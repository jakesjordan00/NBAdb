...
--select distinct shotType, actionType
--from playByPlayPlayoffs
--where shotType != '2PTA' and shotType != 'FTA' and shotType != '3PTA' and shotType != 'FTM' 
--select distinct shotType, actionType
--from playByPlay
--where shotType != '2PTA' and shotType != 'FTA' and shotType != '3PTA' and shotType != 'FTM' 
...
--select * 
--from playByPlay
--where game_id = 21501140

--select distinct season_id
--from playByPlay order by season_id


--select distinct season_id
--from playByPlayPlayoffs order by season_id


--select distinct season_id
--from playerBox order by season_id


--select distinct season_id
--from player order by season_id


--select distinct season_id
--from team order by season_id

--select concat('"', game_id, '",')
--from game
--where season_id = 2017

--select distinct rounddesc from PlayoffSeries
...
--select distinct concat('"00', replace(game_id, '2170', '2180'), '",')
--from game
--where season_id = 2017