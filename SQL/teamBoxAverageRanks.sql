...
SELECT [season_id]
      ...
      ,rank()OVER (PARTITION by season_id order by [blocksReceived]					asc)[blocksReceivedRank]					
      ...
      ,rank()OVER (PARTITION by season_id order by [foulsOffensive]					asc)[foulsOffensiveRank]					
      ,rank()OVER (PARTITION by season_id order by [foulsDrawn]						desc)[foulsDrawnRank]						
      ,rank()OVER (PARTITION by season_id order by [foulsPersonal]					asc)[foulsPersonalRank]					
      ,rank()OVER (PARTITION by season_id order by [foulsTechnical]					asc)[foulsTechnicalRank]					
      ...
      ,rank()OVER (PARTITION by season_id order by [turnovers]						asc)[turnoversRank]						
      ...
      ,rank()OVER (PARTITION by season_id order by [foulsTeam]						asc)[foulsTeamRank]						
      ,rank()OVER (PARTITION by season_id order by [foulsTeamTechnical]				asc)[foulsTeamTechnicalRank]				
      ...
      ,rank()OVER (PARTITION by season_id order by [turnoversTeam]					asc)[turnoversTeamRank]					
      ,rank()OVER (PARTITION by season_id order by [turnoversTotal]					asc)[turnoversTotalRank]					
