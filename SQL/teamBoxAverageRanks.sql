...
SELECT [season_id]
      ...
      ,rank()OVER (PARTITION by season_id order by [pointsAgainst]					desc)[pointsAgainstRank]					
      ...
      ,rank()OVER (PARTITION by season_id order by [q1PointsAgainst]				desc)[q1PointsAgainstRank]				
      ,rank()OVER (PARTITION by season_id order by [q2Points]						desc)[q2PointsRank]						
      ,rank()OVER (PARTITION by season_id order by [q2PointsAgainst]				desc)[q2PointsAgainstRank]				
      ,rank()OVER (PARTITION by season_id order by [q3Points]						desc)[q3PointsRank]						
      ,rank()OVER (PARTITION by season_id order by [q3PointsAgainst]				desc)[q3PointsAgainstRank]				
      ,rank()OVER (PARTITION by season_id order by [q4Points]						desc)[q4PointsRank]						
      ,rank()OVER (PARTITION by season_id order by [q4PointsAgainst]				desc)[q4PointsAgainstRank]				
      ,rank()OVER (PARTITION by season_id order by [otPoints]						desc)[otPointsRank]						
      ,rank()OVER (PARTITION by season_id order by [otPointsAgainst]				desc)[otPointsAgainstRank]				
