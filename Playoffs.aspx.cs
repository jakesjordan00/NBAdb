...
namespace NBAdb
{
    public partial class Playoffs : Page
    {
        ...
        protected void PlayoffSeries(int season)
        {
            ...
            string seasonEndpoint = "https://stats.nba.com/stats/playoffbracket?LeagueID=00&SeasonYear=20" + season + "&State=2";
            try
            {
                WebRequest RequestSeasonPlayoffSeries = WebRequest.Create(seasonEndpoint);
