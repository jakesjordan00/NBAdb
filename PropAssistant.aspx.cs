...
namespace NBAdb
{
    public partial class PropAssistant : System.Web.UI.Page
    {
        ...
        protected void ddTeams_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PopulateRoster();
            TeamAverages(ddTeams.SelectedValue, Int32.Parse(ddSeason.SelectedValue));
        }


        protected void TeamAverages(string team, int season)
        {
            SqlConnection sqlConnect = new SqlConnection("Server=localhost;Database=nbaDB;User Id=test;Password=test123;");
            using (sqlConnect)
            {
                using (SqlCommand querySearch = new SqlCommand("ParlayTeamAverages"))
                {
                    querySearch.Connection = sqlConnect;
                    querySearch.CommandType = CommandType.StoredProcedure;
                    ...
                    using (SqlDataReader sdr = querySearch.ExecuteReader())
                    {
                        while (sdr.Read())
                        {
                            tPts.Text = sdr["points"].ToString();
                            tPtsAgainst.Text = sdr["pointsAgainst"].ToString();
                            tMOV.Text =   Math.Round(double.Parse(sdr["MoV"].ToString())).ToString();

                            tAst.Text =   sdr["assists"].ToString();
                            tFG2.Text =   sdr["twoPointersMade"].ToString() + "/" + sdr["twoPointersAttempted"].ToString() + " - " + sdr["twoPointersPercentage"].ToString();
                            tFG3.Text =   sdr["threePointersMade"].ToString() + "/" + sdr["threePointersAttempted"].ToString() + " - " + sdr["threePointersPercentage"].ToString();
                            tBench.Text = sdr["benchPoints"].ToString();
                        }
                    }
                }
            }
        ...
        protected void ddlRoster_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PropAverages propAverages = new PropAverages();
            propAverages.GetAverages(aWinsChk.Checked, aLossChk.Checked, ddlRoster.SelectedValue, ddTeams.SelectedValue.Remove(0, 6), a1Name, a1Team, a1Points, a1Assists, a1Rebounds, a1Threes, a1Blocks, a1Steals, a1Minutes, a1pd, a1ad, a1rd, a13d, a1bd, a1sd, Int32.Parse(ddSeason.SelectedValue));
            ...
            PropAveragesExtended propAveragesExtended = new PropAveragesExtended();
            ...
            {
                propAveragesExtended.GetProcedure(ddlRoster.SelectedValue, ddlRoster2.SelectedValue, ddlRoster3.SelectedValue, ddlInjured.SelectedValue, ddTeams.SelectedValue, Int32.Parse(ddSeason.SelectedValue), aWinsChk.Checked, aLossChk.Checked);
                ...
                a2StatsSection.Visible = false;
                a3StatsSection.Visible = false;
                propAveragesExtended.PopulateUI(a1Name, a1Team, dyName1, dyTeam1, dyPts1, dyAst1, dyReb1, dy31, dyBlk1, dyStl1, dyMinutes1, 1);
            }
            else if (!ddlRoster.SelectedValue.IsNullOrWhiteSpace() && !ddlRoster2.SelectedValue.IsNullOrWhiteSpace() && ddlRoster3.SelectedValue.IsNullOrWhiteSpace())
            {
                ...
                a3StatsSection.Visible = false;
                propAveragesExtended.PopulateUI(a1Name, a1Team, dyName1, dyTeam1, dyPts1, dyAst1, dyReb1, dy31, dyBlk1, dyStl1, dyMinutes1, 1);
                propAveragesExtended.PopulateUI(a2Name, a2Team, dyName2, dyTeam2, dyPts2, dyAst2, dyReb2, dy32, dyBlk2, dyStl2, dyMinutes2, 2);
            }
            else if (!ddlRoster.SelectedValue.IsNullOrWhiteSpace() && !ddlRoster2.SelectedValue.IsNullOrWhiteSpace() && !ddlRoster3.SelectedValue.IsNullOrWhiteSpace())
            {
                propAveragesExtended.GetProcedure(ddlRoster.SelectedValue, ddlRoster2.SelectedValue, ddlRoster3.SelectedValue, ddlInjured.SelectedValue, ddTeams.SelectedValue, Int32.Parse(ddSeason.SelectedValue), aWinsChk.Checked, aLossChk.Checked);
                ...
                propAveragesExtended.PopulateUI(a1Name, a1Team, dyName1, dyTeam1, dyPts1, dyAst1, dyReb1, dy31, dyBlk1, dyStl1, dyMinutes1, 1);
                propAveragesExtended.PopulateUI(a2Name, a2Team, dyName2, dyTeam2, dyPts2, dyAst2, dyReb2, dy32, dyBlk2, dyStl2, dyMinutes2, 2);
                propAveragesExtended.PopulateUI(a3Name, a3Team, dyName3, dyTeam3, dyPts3, dyAst3, dyReb3, dy33, dyBlk3, dyStl3, dyMinutes3, 3);
            }
            else
            {
        ...
        protected void ddlRoster2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            a2StatsSection.Visible = true;
            PropAverages propAverages = new PropAverages();
            propAverages.GetAverages(aWinsChk.Checked, aLossChk.Checked, ddlRoster2.SelectedValue, ddTeams.SelectedValue.Remove(0, 6), a2Name, a2Team, a2Points, a2Assists, a2Rebounds, a2Threes, a2Blocks, a2Steals, a2Minutes, a2pd, a2ad, a2rd, a23d, a2bd, a2sd, Int32.Parse(ddSeason.SelectedValue));
            PropAveragesExtended propAveragesExtended = new PropAveragesExtended();
            if (!ddlRoster.SelectedValue.IsNullOrWhiteSpace() && !ddlInjured.SelectedValue.IsNullOrWhiteSpace() && ddlRoster2.SelectedValue.IsNullOrWhiteSpace() && ddlRoster3.SelectedValue.IsNullOrWhiteSpace())
            {
                propAveragesExtended.GetProcedure(ddlRoster.SelectedValue, ddlRoster2.SelectedValue, ddlRoster3.SelectedValue, ddlInjured.SelectedValue, ddTeams.SelectedValue, Int32.Parse(ddSeason.SelectedValue), aWinsChk.Checked, aLossChk.Checked);
        ...
        protected void ddlRoster3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            a3StatsSection.Visible = true;
            PropAverages propAverages = new PropAverages();
            propAverages.GetAverages(aWinsChk.Checked, aLossChk.Checked, ddlRoster3.SelectedValue, ddTeams.SelectedValue.Remove(0, 6), a3Name, a3Team, a3Points, a3Assists, a3Rebounds, a3Threes, a3Blocks, a3Steals, a3Minutes, a3pd, a3ad, a3rd, a33d, a3bd, a3sd, Int32.Parse(ddSeason.SelectedValue));
            PropAveragesExtended propAveragesExtended = new PropAveragesExtended();
            if (!ddlRoster.SelectedValue.IsNullOrWhiteSpace() && !ddlInjured.SelectedValue.IsNullOrWhiteSpace() && ddlRoster2.SelectedValue.IsNullOrWhiteSpace() && ddlRoster3.SelectedValue.IsNullOrWhiteSpace())
            {
                propAveragesExtended.GetProcedure(ddlRoster.SelectedValue, ddlRoster2.SelectedValue, ddlRoster3.SelectedValue, ddlInjured.SelectedValue, ddTeams.SelectedValue, Int32.Parse(ddSeason.SelectedValue), aWinsChk.Checked, aLossChk.Checked);
        ...
        protected void btnRetrieve_Click(object sender, EventArgs e)
        {
            ...
            propBuilder.BuildQuery(Team, PlayerList, player1, player2, player3, playerI, PropList, Player1Props, Player2Props, Player3Props);
        ...
        protected void ddSeason_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PopulateRoster();
            TeamAverages(ddTeams.SelectedValue, Int32.Parse((string)ddSeason.SelectedValue));
